...
def test_get_redirect(client: TestClient) -> None:
    ...
    data = r.json()
    # Accept both /redirecforTest1 and {STATIC_URL}/redirecforTest1 for compatibility
    assert data["redirect"] in [f"{settings.STATIC_URL}/redirecforTest1", "/redirecforTest1"]
