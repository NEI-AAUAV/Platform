...
from .subject import SubjectInDB, SubjectCreate, SubjectUpdate
...
from .user_academic_details import (
    UserAcademicDetailsInBD,
    UserAcademicDetailsCreate,
    UserAcademicDetailsUpdate,
)
