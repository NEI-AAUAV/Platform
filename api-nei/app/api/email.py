...
async def send_magic_link(email: str, name: str, reason: str, token: str):
    """Sends an email with a magic link to activate the user's account
    ...
    * `token`: The magic link token
    """
    bodies = template.render_magic_link_templates(email, name, reason, token)
    message = _generate_email_message(email, "Ativa a tua conta no site do NEI", bodies)
