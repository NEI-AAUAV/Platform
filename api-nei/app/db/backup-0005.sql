...
--
-- Name: user_matriculation__subjects; Type: TABLE; Schema: nei; Owner: postgres
--

CREATE TABLE nei.user_matriculation__subjects (
    user_matriculation_id integer NOT NULL,
    subject integer NOT NULL
);


ALTER TABLE nei.user_matriculation__subjects OWNER TO postgres;
...
INSERT INTO nei.news (id, header, status, title, category, content, created_at, updated_at, author_id) VALUES
	...
	(19, '/news/colaboradores.jpg', 'ACTIVE', 'Vem ser nosso Colaborador!', 'EVENT', 'És um estudante ativo?<br>Procuras aprender novas competências e desenvolver novas?<br>Gostavas de ajudar o teu núcleo a proporcionar as melhores atividades da Universidade?<br>Se respondeste sim a pelo menos uma destas questões clica <a href=\https://forms.gle/3y5JZfNvN7rBjFZT8\ target=\_blank\>aqui</a><br>E preenche o formulário!<br>Sendo um colaborador do NEI vais poder desenvolver várias capacidades, sendo que maioria delas não são abordadas nas Unidades Curriculares!<br>Vais fazer amizades e a cima de tudo vais te divertir!<br>Junta-te a nós e ajuda o NEI a desenvolver as melhores atividades possíveis!', '2020-02-19 00:00:00', NULL, 1),
...
INSERT INTO nei.subject (code, public, name, short, link) VALUES
	(43948, true, 'EMPREENDEDORISMO', 'E', 'https://www.ua.pt/pt/uc/2373'),
	(41302, true, 'GESTÃO DE EMPRESAS', 'GE', 'https://www.ua.pt/pt/uc/2450'),
	(43460, true, 'ARQUITECTURA E GESTÃO DE REDES', 'AGR', 'https://www.ua.pt/pt/uc/9270'),
	(40386, true, 'ASPETOS PROFISSIONAIS E SOCIAIS DA ENGENHARIA INFORMÁTICA', 'APSEI', 'https://www.ua.pt/pt/uc/12271'),
	(40532, true, 'COMPLEMENTOS SOBRE LINGUAGENS DE PROGRAMAÇÃO', 'CSLP', 'https://www.ua.pt/pt/uc/12830'),
	(40534, true, 'TÓPICOS DE APRENDIZAGEM AUTOMÁTICA', 'TAA', 'https://www.ua.pt/pt/uc/12832'),
	(41769, true, 'MODELAÇÃO DE SISTEMAS FÍSICOS', 'MSF', 'https://www.ua.pt/pt/uc/14817'),
	(40337, true, 'MÉTODOS PROBABILÍSTICOS PARA ENGENHARIA INFORMÁTICA', 'MPEI', ''),
	(40379, true, 'FUNDAMENTOS DE PROGRAMAÇÃO', 'FP', ''),
	(40380, true, 'INTRODUÇÃO ÀS TECNOLOGIAS WEB', 'ITW', ''),
	(40381, true, 'SISTEMAS OPERATIVOS', 'SO', ''),
	(40382, true, 'COMPUTAÇÃO DISTRIBUÍDA', 'CD', ''),
	(40383, true, 'PADRÕES E DESENHO DE SOFTWARE', 'PDS', ''),
	(40384, true, 'INTRODUÇÃO À ENGENHARIA DE SOFTWARE', 'IES', ''),
	(40385, true, 'COMPLEMENTOS DE BASES DE DADOS', 'CBD', ''),
	(40431, true, 'MODELAÇÃO E ANÁLISE DE SISTEMAS', 'MAS', ''),
	(40432, true, 'SISTEMAS MULTIMÉDIA', 'SM', ''),
	(40433, true, 'REDES E SERVIÇOS', 'RS', ''),
	(40436, true, 'PROGRAMAÇÃO ORIENTADA A OBJETOS', 'POO', ''),
	(40437, true, 'ALGORITMOS E ESTRUTURAS DE DADOS', 'AED', ''),
	(40551, true, 'TECNOLOGIAS E PROGRAMAÇÃO WEB', 'TPW', ''),
	(40751, true, 'ALGORITMOS AVANÇADOS', 'AA', ''),
	(40752, true, 'TEORIA ALGORÍTMICA DA INFORMAÇÃO', 'TAI', ''),
	(40753, true, 'COMPUTAÇÃO EM LARGA ESCALA', 'CLE', ''),
	(40756, true, 'GESTÃO DE INFRAESTRUTURAS DE COMPUTAÇÃO', 'GIC', ''),
	(40757, true, 'ARQUITETURAS DE SOFTWARE', 'AS', ''),
	(40846, true, 'INTELIGÊNCIA ARTIFICIAL', 'IA', ''),
	(41469, true, 'COMPILADORES', 'C', ''),
	(41549, true, 'INTERAÇÃO HUMANO-COMPUTADOR', 'IHC', ''),
	(41791, true, 'ELEMENTOS DE FISÍCA', 'EF', ''),
	(42502, true, 'INTRODUÇÃO À ARQUITETURA DE COMPUTADORES', 'IAC', ''),
	(42532, true, 'BASES DE DADOS', 'BD', ''),
	(42573, true, 'SEGURANÇA INFORMÁTICA E NAS ORGANIZAÇÕES', 'SIO', ''),
	(42709, true, 'ÁLGEBRA LINEAR E GEOMETRIA ANALÍTICA', 'ALGA', ''),
	(42728, true, 'CÁLCULO I', 'C-I', ''),
	(42729, true, 'CÁLCULO II', 'C-II', ''),
	(44156, true, 'VISUALIZAÇÃO DE INFORMAÇÃO', 'VI', ''),
	(44130, true, 'WEB SEMÂNTICA', 'WS', ''),
	(45424, true, 'INTRODUÇÃO À COMPUTAÇÃO MÓVEL', 'ICM', ''),
	(45426, true, 'TESTE E QUALIDADE DE SOFTWARE', 'TQS', ''),
	(45587, true, 'EXPLORAÇÃO DE DADOS', 'ED', ''),
	(47166, true, 'Matemática Discreta', 'MD', ''),
	(41226, true, 'ROBÓTICA MÓVEL INTELIGENTE', 'RMI', ''),
	(43370, false, 'LÍNGUA CHINESA I', '', ''),
	(49711, false, 'PREPARAÇÃO DE DISSERTAÇÃO / ESTÁGIO', '', ''),
	(49997, false, 'DISSERTAÇÃO / ESTÁGIO', '', ''),
	(41770, false, 'REDES E SERVIÇOS', '', ''),
	(40754, false, 'SISTEMAS DE INFORMAÇÃO NAS ORGANIZAÇÕES', '', ''),
	(41492, false, 'ENGENHARIA DE SOFTWARE', '', ''),
	(42596, false, 'RECUPERAÇÃO DE INFORMAÇÃO', '', ''),
	(44139, false, 'COMPUTAÇÃO MÓVEL', 'CM', ''),
	(44158, false, 'WEB SEMÂNTICA', 'WS', ''),
	(41010, false, 'FUNDAMENTOS DE APRENDIZAGEM AUTOMÁTICA', '', ''),
	(41687, false, 'MINERAÇÃO DE DADOS EM LARGA ESCALA', '', ''),
	(41781, false, 'ANÁLISE E EXPLORAÇÃO DE VULNERABILIDADES', '', ''),
	(40387, false, 'PROJETO EM INFORMÁTICA', '', ''),
	(41495, false, 'ELETRÓNICA ANALÓGICA', '', ''),
	(40664, false, 'TEORIAS DA COMUNICAÇÃO', '', ''),
	(41652, false, 'MATERIAIS E TECNOLOGIAS I', '', ''),
	(41654, false, 'DESIGN DE INTERACÇÃO', '', ''),
	(41656, false, 'MATERIAIS E TECNOLOGIAS II', '', ''),
	(41658, false, 'DESENHO E EXPRESSÃO II', '', ''),
	(41663, false, 'HISTÓRIA DO DESIGN PORTUGUÊS', '', ''),
	(42484, false, 'REPROGRAFIA', '', ''),
	(47068, false, 'DESENHO E EXPRESSÃO I', '', ''),
	(49980, false, 'PROJECTO EM DESIGN II', '', ''),
	(49981, false, 'PROJECTO EM DESIGN III', '', ''),
	(41779, false, 'SOFTWARE ROBUSTO', '', ''),
	(41780, false, 'CRIPTOGRAFIA APLICADA', '', ''),
	(41782, false, 'SEGURANÇA EM REDES DE COMUNICAÇÕES', '', ''),
	(41783, false, 'IDENTIFICAÇÃO, AUTENTICAÇÃO E AUTORIZAÇÃO', '', ''),
	(41231, false, 'INTERAÇÃO MULTIMODAL', '', ''),
	(49705, false, 'OPÇÃO A4', '', ''),
	(49706, false, 'OPÇÃO A3', '', ''),
	(49707, false, 'OPÇÃO B6', '', ''),
	(49708, false, 'OPÇÃO B5', '', ''),
	(49709, false, 'OPÇÃO B4', '', ''),
	(45423, false, 'INTRODUÇÃO À COMPUTAÇÃO GRÁFICA', '', ''),
	(40914, false, 'INVESTIGAÇÃO OPERACIONAL', '', ''),
	(40755, false, 'SIMULAÇÃO E OTIMIZAÇÃO', '', ''),
	(41877, false, 'SISTEMAS INTELIGENTES II', '', ''),
	(41749, false, 'PRÁTICA DE SOLDADURA', '', '');
...
SELECT pg_catalog.setval('nei.user_matriculation_id_seq', 103, true);
...
--
-- Name: user_matriculation__subjects user_matriculation__subjects_pkey; Type: CONSTRAINT; Schema: nei; Owner: postgres
--

ALTER TABLE ONLY nei.user_matriculation__subjects
    ADD CONSTRAINT user_matriculation__subjects_pkey PRIMARY KEY (user_matriculation_id, subject);
...
--
-- Name: user_matriculation__subjects user_matriculation__subjects_subject_fkey; Type: FK CONSTRAINT; Schema: nei; Owner: postgres
--

ALTER TABLE ONLY nei.user_matriculation__subjects
    ADD CONSTRAINT user_matriculation__subjects_subject_fkey FOREIGN KEY (subject) REFERENCES nei.subject(code);


--
-- Name: user_matriculation__subjects user_matriculation__subjects_user_matriculation_id_fkey; Type: FK CONSTRAINT; Schema: nei; Owner: postgres
--

ALTER TABLE ONLY nei.user_matriculation__subjects
    ADD CONSTRAINT user_matriculation__subjects_user_matriculation_id_fkey FOREIGN KEY (user_matriculation_id) REFERENCES nei.user_matriculation(id);
