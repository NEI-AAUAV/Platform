    ...
    with engine.connect() as conn:
        if not engine.dialect.has_schema(conn, schema=settings.SCHEMA_NAME):
            ...
            if not settings.PRODUCTION:
                ...
                stmts = text("""
                INSERT INTO nei."user" (id, email, name, surname, updated_at, created_at, scopes, hashed_password, active) VALUES
                (0, 'dev@dev.dev', 'Dev', 'Test', '2023-01-01T00:00:00', '2023-01-01T00:00:00', ARRAY['ADMIN']::nei.scope_enum[], '$argon2id$v=19$m=65536,t=3,p=4$IqRUqvW+N8a4d865F4KQ0g$orC7ZOBIJG3t0XOhzmKNaewh7OwgfWuoj2SGEb4OcHQ', TRUE);
                """)
                conn.execute(stmts)
                conn.commit()
