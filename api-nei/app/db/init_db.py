    ...
    with engine.connect() as conn:
        if not engine.dialect.has_schema(conn, schema=settings.SCHEMA_NAME):
            ...
            if not settings.PRODUCTION:
                ...
                (0, 'Dev', 'Test', '2023-01-01T00:00:00', '2023-01-01T00:00:00', ARRAY['ADMIN']::nei.scope_enum[], '$argon2id$v=19$m=65536,t=3,p=4$IqRUqvW+N8a4d865F4KQ0g$orC7ZOBIJG3t0XOhzmKNaewh7OwgfWuoj2SGEb4OcHQ', '2023-01-01T00:00:00');
