from sqlalchemy import Column, ForeignKey, SmallInteger, Integer, String, Text
...
class TacaUAClassification(Base):
    ...
    team_id = Column(Integer, ForeignKey("tacaua_team.id"), primary_key=True)
    modality_id = Column(Integer, ForeignKey("tacaua_modality.id"), primary_key=True)
