  ...
  return (
    <>
      <div className="m-auto sm:max-w-md h-fit bg-base-200 rounded-2xl py-6 px-14 drop-shadow-lg shadow-secondary z-10 flex flex-col align-middle max-w-[80%]">
        ...
        <button className="btn btn-lg m-auto mt-8 mb-3 py-3 sm:px-6 px-8"><img src={logo} className='object-fit bg-center max-h-full'/></button>
        ...
        <form onSubmit={formSubmitted}>
          <div className="flex flex-col">
            ...
            <input
              ...
              type="password"
            />
            <button className="btn btn-primary sm:btn-wide m-auto btn-block" type="submit">
              Login
            </button>
