                    ...
                    <>
                        ...
                        >
                            <button className="btn btn-sm btn-outline-primary mb-3 ml-0">
                                <FontAwesomeIcon
                                    icon={note.type?.icon_download.split(" ")}
                                    size={"1x"}
                                />
                                <span className="ml-1">{note.type?.download_caption}</span>
                            </button>
                        </a>
                        {
                            false &&
                                    ...
                                    <>
                                        <dt className="small font-weight-bold">
                                            ...
                                            <FontAwesomeIcon
                                                ...
                                                onClick={() => { setSelYear(note.school_year?.year_id); setSelPage(1) }}
                                            />
                                        </dt>
                                        <dd>{note.school_year?.year_begin}/{note.school_year?.year_end}</dd>
                                    </>
                                }
                                {
                                    !!note.subject?.name &&
                                        ...
                                        <dt className="small font-weight-bold">
                                            <span className="mr-1">
                                                ...
                                                <FontAwesomeIcon
                                                    ...
                                                    onClick={() => { setSelTeacher(note.teacher?.id); setSelPage(1) }}
                                                />
                                            </span>
                                            {
