...
const Components = () => {
  return (
    <div>
              ...
              {colors.map(({ name, key, required }) => (
                <tr className="flex grow">
                  <td className="w-1/2">
                    ...
                    ></span>
                    <span
                      className={classname("float-right m-2 badge badge-sm", {
      ...
      <div className="md:flex-row flex-col flex mb-12">
        <DCard
          type="news"
          data={{
            title: "Uma noticia",
            link: "https://google.com",
            header: "https://picsum.photos/200/200",
            date: "25-02-2023",
            category: "Event",
          }}
        />
        <DCard
          ...
          data={{
            title: "Um partner",
            description: "Uma descrição muito grande para um card de parceiro",
            link: "https://google.com",
