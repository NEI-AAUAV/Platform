...
GRANT ALL PRIVILEGES ON DATABASE postgres_test TO docker;
\connect postgres;
CREATE SCHEMA IF NOT EXISTS aauav_nei;
...
CREATE TABLE aauav_nei.classificacao_tacaua (
  ...
  njogos integer  NOT NULL DEFAULT '0',
  vitorias integer  NOT NULL DEFAULT '0',
  empates integer  DEFAULT NULL,
  derrotas integer  NOT NULL DEFAULT '0',
  fc integer  NOT NULL DEFAULT '0',
  gmarcados integer  NOT NULL DEFAULT '0',
  gsofridos integer  NOT NULL DEFAULT '0'
);

INSERT INTO aauav_nei.classificacao_tacaua (id, idModalidade, idEquipa, pontuacao, njogos, vitorias, empates, derrotas, fc, gmarcados, gsofridos) VALUES
...
INSERT INTO aauav_nei.companies (id, name, email, permission, password) VALUES
...
-- TODO: move to tacaua schema

INSERT INTO aauav_nei.equipas_tacaua (id, nome) VALUES
(1, 'EET'),
(2, 'Marketing'),
(3, 'Contabilidade'),
(4, 'Enfermagem'),
...
CREATE TABLE aauav_nei.estatistica (
  id integer NOT NULL,
...
INSERT INTO aauav_nei.estatistica (id, acessos) VALUES
(840, 1),
(843, 10),
(870, 1),
(921, 1),
...
INSERT INTO aauav_nei.faina (mandato, imagem, anoLetivo) VALUES
(2012, NULL, '2012/2013'),
(2013, NULL, '2013/2014'),
(2014, NULL, '2014/2015'),
(2015, NULL, '2015/2016'),
...
(2021, '/faina/team/2021.jpg', '2021/2022');
...
INSERT INTO aauav_nei.faina_memb (id, nome, ano) VALUES
...
INSERT INTO aauav_nei.faina_member (id, member, year, role) VALUES
(4, 1179, 2012, 10),
(7, 1593, 2012, 7),
(10, 1062, 2012, 5),
(13, 1080, 2012, 5),
...
-- TODO: is this necessary? in users table maybe
...
INSERT INTO aauav_nei.GenTokens (id, userid, token, expire_date) VALUES
...
INSERT INTO aauav_nei.GenTokensComp (id, compid, token, expire_date) VALUES
...
CREATE TABLE aauav_nei.jogos_tacaua (
  ...
  golosCasa integer NOT NULL DEFAULT '0',
  golosFora integer NOT NULL DEFAULT '0',
  jornada integer NOT NULL,
  data text NOT NULL,
  fc integer DEFAULT NULL,
...
-- TODO: pode ser util no frontend, mas nao vale a pena estar numa BD

INSERT INTO aauav_nei.Links (id, nome, link) VALUES
...
(10, 'Cachecol de curso', '/merch/scarf.png', 3.5, 0),
(13, 'Casaco de curso', '/merch/casaco.png', 16.5, 0),
(16, 'Sweat de curso', '/merch/sweat.png', 18, 0),
(19, 'Emblema NEI', '/merch/emblemanei.png', 2.5, 0);
...
CREATE TABLE aauav_nei.modalidades_tacaua (
  ...
  grupo text,
  pontos_vitoria integer NOT NULL,
  pontos_empate integer DEFAULT NULL,
  pontos_derrota integer NOT NULL
);

--
-- Dumping data for table modalidades_tacaua
-- TODO: can be useful for tacaua history

INSERT INTO aauav_nei.modalidades_tacaua (id, modalidade, tipo_modalidade, ano_letivo, divisao, grupo, pontos_vitoria, pontos_empate, pontos_derrota) VALUES
...
CREATE TABLE aauav_nei.NEI_Disciplina (
...
INSERT INTO aauav_nei.NEI_Disciplina (paco_code, nome, ano, semestre, short) VALUES
...
CREATE TABLE aauav_nei.NEI_Disciplina_Apontamentos (
  disciplina integer NOT NULL,
  link_ficheiro character varying(200) NOT NULL,
  nome_recurso character varying(100) NOT NULL DEFAULT '-',
  autor character varying(40) NOT NULL DEFAULT '-',
  CHECK (disciplina>=0)
);
...
INSERT INTO aauav_nei.NEI_Disciplina_Apontamentos (disciplina, link_ficheiro, nome_recurso, autor) VALUES
...
CREATE TABLE aauav_nei.NEI_Merch (
  ...
  estado aauav_nei.bi NOT NULL DEFAULT '0',
...
INSERT INTO aauav_nei.NEI_Merch (id, data, hora, nome, email, estado, ficheiro) VALUES
...
CREATE TABLE aauav_nei.news (
  ...
  publish_by integer NOT NULL,
  created_at date NOT NULL,
  last_change_at date DEFAULT NULL,
  changed_by integer DEFAULT NULL,
  author integer DEFAULT NULL
);

comment on column aauav_nei.news.status is '0 if disable 1 if showing';
comment on column aauav_nei.news.publish_by is 'user id that created new';
comment on column aauav_nei.news.created_at is 'When new created';
comment on column aauav_nei.news.last_change_at is 'When new was last changed';
comment on column aauav_nei.news.changed_by is 'user id that changed new';

--
-- Dumping data for table news
--

INSERT INTO aauav_nei.news (id, header, status, title, category, content, publish_by, created_at, last_change_at, changed_by, author) VALUES
...
CREATE TABLE aauav_nei.notes (
  ...
  author integer DEFAULT NULL,
  schoolYear integer DEFAULT NULL,
  teacher integer DEFAULT NULL,
  summary smallint DEFAULT NULL,
  tests smallint DEFAULT NULL,
  bibliography smallint DEFAULT NULL,
  slides smallint DEFAULT NULL,
  exercises smallint DEFAULT NULL,
  projects smallint DEFAULT NULL,
  notebook smallint DEFAULT NULL,
  content text,
...
INSERT INTO aauav_nei.notes (id, name, location, subject, author, schoolYear, teacher, summary, tests, bibliography, slides, exercises, projects, notebook, content, createdAt, type, size) VALUES
...
INSERT INTO aauav_nei.notes_schoolyear (id, yearBegin, yearEnd) VALUES
(1, 2014, 2015),
(2, 2017, 2018),
(3, 2018, 2019),
(4, 2016, 2017),
...
CREATE TABLE aauav_nei.notes_subjects (
  paco_code integer NOT NULL,
...
INSERT INTO aauav_nei.notes_subjects (paco_code, name, year, semester, short, discontinued, optional) VALUES
...
INSERT INTO aauav_nei.notes_teachers (id, name, personalPage) VALUES
...
INSERT INTO aauav_nei.notes_thanks (id, author, notesPersonalPage) VALUES
...
CREATE TABLE aauav_nei.notes_types (
  ...
  icon_download character varying(40) DEFAULT NULL,
...
CREATE TABLE aauav_nei.partners (
  ...
  bannerUrl character varying(255) DEFAULT NULL,
  bannerImage character varying(255) DEFAULT NULL,
  bannerUntil timestamp DEFAULT NULL
);
...
INSERT INTO aauav_nei.partners (id, header, company, description, content, link, bannerUrl, bannerImage, bannerUntil) VALUES
...
INSERT INTO aauav_nei.redirects (id, alias, redirect) VALUES
...
INSERT INTO aauav_nei.rgm (id, categoria, mandato, file) VALUES
...
(156, 'ATAS', 2022, '/rgm/ATAS/2022/2.pdf'),
(159, 'PAO', 2022, '/rgm/PAO/2022/PAO_NEI2022-23.pdf'),
(162, 'RAC', 2022, '/rgm/RAC/2022/RAC_NEI2022.pdf');
...
CREATE TABLE aauav_nei.seniors_students (
  ...
  course character varying(3) NOT NULL,
  userId integer NOT NULL,
  quote character varying(280) DEFAULT NULL,
  image character varying(255) DEFAULT NULL
);
...
INSERT INTO aauav_nei.seniors_students (year, course, userId, quote, image) VALUES
...
CREATE TABLE aauav_nei.tacaua_classification (
  ...
  g_scored smallint NOT NULL,
  g_conceded smallint NOT NULL
);
...
INSERT INTO aauav_nei.tacaua_classification (team, modality, score, games, victories, draws, defeats, g_scored, g_conceded) VALUES
(0, 1, 3, 3, 0, 0, 3, 32, 55),
(1, 1, 7, 3, 2, 0, 1, 77, 43);
...
INSERT INTO aauav_nei.tacaua_games (id, team1, team2, goals1, goals2) VALUES
(4, 0, 1, 15, 22);
...
CREATE TABLE aauav_nei.tacaua_modalities (
  ...
  division_group character varying(5) DEFAULT NULL,
  pts_victory smallint DEFAULT NULL,
  pts_draw smallint DEFAULT NULL,
  pts_defeat smallint DEFAULT NULL
);
...
INSERT INTO aauav_nei.tacaua_modalities (id, name, type, gender, year, division, division_group, pts_victory, pts_draw, pts_defeat) VALUES
...
INSERT INTO aauav_nei.tacaua_teams (id, name, image) VALUES
...
INSERT INTO aauav_nei.team (id, header, mandato, user_id, role) VALUES
...
CREATE TABLE aauav_nei.team_colaborators (
  colaborator integer DEFAULT NULL,
  mandate integer DEFAULT NULL
);
...
INSERT INTO aauav_nei.team_colaborators (colaborator, mandate) VALUES
(2104, 2021),
(2132, 2021),
(2136, 2021),
(2033, 2021),
...
CREATE TABLE aauav_nei.users (
  ...
  uu_iupi character varying(255) NOT NULL,
  curriculo character varying(255) NOT NULL,
  linkedIn character varying(255) NOT NULL,
  git character varying(255) NOT NULL,
  permission aauav_nei.user_roles NOT NULL,
  created_at date NOT NULL
);
...
(840, 'Afonso Rodrigues', 'AFONSO ANTÓNIO MAIA RODRIGUES', 'aamrodrigues@ua.pt', '2DAF6140-A055-4F1D-BFE6-6E79D9A0B345', '', '', '', '', '1971-01-01'),
(843, 'Alexandre Rodrigues', 'ALEXANDRE ANTUNES RODRIGUES', 'aarodrigues@ua.pt', '8D850DA2-EB43-4D1E-A2C9-6DD7FA1E48DD', '', '', '', '', '1971-01-01'),
...
(864, 'Afonso Silva', 'AFONSO DE SALGUEIRO E SILVA', 'afonsosilva6@ua.pt', '7C325E15-DEFA-4E5B-8E45-C02CF50B6970', '', '', '', '', '1971-01-01'),
(867, 'André Almeida', 'ANDRÉ GOMES DE ALMEIDA', 'aga@ua.pt', 'FC6F9D25-CBBF-4F7C-8BE3-29752FBBAA37', '', '', '', '', '2013-09-12'),
(870, 'Alexandra Carvalho', 'ALEXANDRA TEIXEIRA DE SOUSA MARQUES DE CARVALHO', 'alexandracarvalho@ua.pt', 'B7D45431-DAE9-4320-BD68-9FD26DD01152', '', '', '', '', '1971-01-01'),
...
(882, 'Miguel Almeida', 'MIGUEL ÂNGELO FERNANDES DE ALMEIDA', 'almeida.m@ua.pt', '35076817-7687-4DAD-88D6-2934A7131C34', '', '', '', '', '1971-01-01'),
...
(933, 'Anthony Pereira', 'ANTHONY DOS SANTOS PEREIRA', 'anthonypereira@ua.pt', '922D8550-C063-41FC-85AA-B3CB00818B3D', '', '', '', '', '1971-01-01'),
...
(945, 'António Fernandes', 'ANTÓNIO JORGE OLIVEIRA FERNANDES', 'antoniojorgefernandes@ua.pt', '516B2525-3A36-4194-836A-56632BD275E0', '', '', '', '', '1971-01-01'),
...
(993, 'Bruno Bastos', 'BRUNO DE SOUSA BASTOS', 'brunosb@ua.pt', '588FF064-CAB3-4718-AD1C-00D4C113C0DC', '', '', '', '', '1971-01-01'),
...
(1020, 'Carolina Araújo', 'CAROLINA SIMÕES ARAÚJO', 'carolina.araujo00@ua.pt', 'B644062B-1275-4AE1-BA60-7E2783D72F78', '', '', '', '', '1971-01-01'),
...
(1068, 'Dinis Cruz', 'DINIS BARROQUEIRO CRUZ', 'cruzdinis@ua.pt', '9D8BCB3A-6022-4AF9-9B56-C3879D17D7C6', '', '', '', '', '1971-01-01'),
...
(1074, 'Daniel Gomes', 'DANIEL DE AMARAL GOMES', 'dagomes@ua.pt', 'E546076D-C0A9-4A10-8C1C-344399F86BA4', '', '', '', '', '1971-01-01'),
(1077, 'Daniel Couto', 'DANIEL SERAFIM GOMES COUTO', 'daniel.couto@ua.pt ', 'C957CF34-150C-4545-A6FA-640CBF07D75D', '', '', '', '', '1971-01-01'),
...
(1113, 'David Morais', 'DAVID GOMES MORAIS', 'davidmorais35@ua.pt', 'B6438AEE-A01B-4112-A8F2-BF326B1EFD18', '', '', '', '', '1971-01-01'),
...
(1122, 'Diogo Carvalho', 'DIOGO FILIPE AMARAL CARVALHO', 'dfac@ua.pt', '4B5560CD-9D67-4ACC-95C8-13D370264521', '', '', '', '', '1971-01-01'),
(1125, 'Diogo Cunha', 'DIOGO GUILHERME ROCHA CUNHA', 'dgcunha@ua.pt', 'FB2E2BE1-ED33-49DE-870D-1A18A33D241D', '', '', '', '', '1971-01-01'),
(1128, 'Diego Santos', 'DIEGO ALESSANDRO BATISTA SANTOS', 'diego.santos@ua.pt', 'DAE94FDC-99FA-4AD9-A4D0-D682209E2278', '', '', '', '', '1971-01-01'),
...
(1146, 'Diogo Moreita', 'DIOGO EMANUEL DE OLIVEIRA MOREIRA', 'diogo.e.moreira@ua.pt', 'E6175917-4FD8-4903-BBA1-B8799820CE3C', '', '', '', '', '1971-01-01'),
(1149, 'Diogo Silva', 'DIOGO GUIMARÃES SILVA', 'diogo.g@ua.pt', '10694C97-193E-48E8-A58B-2DEA9BA74455', '', '', '', '', '1971-01-01'),
...
(1164, 'Diogo Bento', 'DIOGO OLIVEIRA BENTO', 'diogobento@ua.pt', '849B6413-3265-463A-91DB-4B650CDEA75E', '', '', '', '', '1971-01-01'),
...
(1182, 'Duarte Mortágua', 'DUARTE NEVES TAVARES MORTÁGUA', 'duarte.ntm@ua.pt', '0798A134-0DBB-4E1F-88D1-24358E6C6AF9', '', 'https://www.linkedin.com/in/duartemortagua/', 'https://github.com/DNTM2802', '', '1971-01-01'),
...
(1200, 'Eduardo Santos', 'EDUARDO HENRIQUE FERREIRA SANTOS', 'eduardosantoshf@ua.pt', 'DC2AC32D-50A9-403A-BA15-A492640FD869', '', 'https://www.linkedin.com/in/eduardosantoshf/', '', '', '1971-01-01'),
...
(1215, 'Fábio Carmelino', 'FÁBIO ALEXANDRE ANDRADE CARMELINO', 'faac@ua.pt', 'AAFD5676-61F0-4F10-97F0-6C152BD03C85', '', '', '', '', '1971-01-01'),
...
(1254, 'Francisca Barros', 'FRANCISCA INÊS MARCOS DE BARROS', 'francisca.mbarros@ua.pt', '27F22927-E453-4AE1-B78E-BBE67C8218E1', '', '', '', '', '1971-01-01'),
...
(1275, 'Gonçalo Matos', 'GONÇALO ANDRÉ FERREIRA MATOS', 'gmatos.ferreira@ua.pt', 'ADE949DB-D390-4AC3-82FB-9F1D609FEA8D', '', 'https://www.linkedin.com/in/goncalofmatos/', '', '', '1971-01-01'),
...
(1326, 'Hugo Ferreira', 'HUGO DINIS OLIVEIRA FERREIRA', 'hugodinis@ua.pt', 'BB7590A4-9C27-4F56-A892-FA8426EA681B', '', '', '', '', '1971-01-01'),
(1329, 'Hugo Almeida', 'HUGO FILIPE RIBEIRO PAIVA DE ALMEIDA', 'hugofpaiva@ua.pt', 'A08FAA58-5EB0-444F-B4D5-A538E5A915C5', '', 'https://www.linkedin.com/in/hugofpaiva/', '', '', '1971-01-01'),
...
(1341, 'Inês Leite', 'INÊS PINHO LEITE', 'ines.pl@ua.pt', '3095F985-9843-4EF4-A0DA-A1396CEE7AA3', '', '', '', '', '1971-01-01'),
(1344, 'Maria Rocha', 'MARIA INÊS SEABRA ROCHA', 'ines.seabrarocha@ua.pt', 'DEB666E5-3DB2-4E4F-A4B5-C3A1E5AD3077', '', '', '', '', '1971-01-01'),
(1347, 'Inês Pombinho', 'INÊS COSTA POMBINHO', 'inespombinho@ua.pt', '1353F351-E649-4D58-875E-E59E3601B131', '', '', '', '', '2017-10-23'),
(1350, 'Isadora Loredo', 'ISADORA FERREIRA LOREDO', 'isadora.fl@ua.pt', '7200E484-B90B-4257-9E57-60D9541A70E0', '/upload/curriculos/1350.pdf', 'https://www.linkedin.com/in/isadora-f-loredo/', 'https://github.com/flisadora', '', '1971-01-01'),
...
(1374, 'João Catarino', 'JOÃO FRANCISCO TEIXEIRA CATARINO', 'jftcatarino@ua.pt', '3C5A4E24-0648-4AFF-AB20-74620471EFE3', '', '', '', '', '1971-01-01'),
...
(1431, 'João Lourenço', 'JOÃO MIGUEL ISIDORO DA ROCHA LOURENÇO', 'joaomiguellourenco@ua.pt', 'BF89508C-AF78-40D8-BA28-F5D5EB4C0ADC', '', '', '', '', '1971-01-01'),
...
(1461, 'João Soares', 'JOÃO TEIXEIRA SOARES', 'joaots@ua.pt', 'D18FF07E-2577-47D0-B038-94D5AE7CA829', '', '', '', '', '1971-01-01'),
...
(1470, 'Jorge Leite', 'JORGE BARROCAS LEITE', 'jorgeleite@ua.pt', '8059E358-46BC-4F3D-AEF6-5FE398DE8FAA', '', '', '', '', '1971-01-01'),
...
(1479, 'José Sousa', 'JOSÉ LUCAS MIMOSO DONAS BOTTO SOUSA', 'joselmdbsousa@ua.pt', '9CA67BF3-30F1-4E86-9EB9-135F5557CA5B', '', '', '', '', '1971-01-01'),
...
(1521, 'Leandro Silva', 'LEANDRO EMANUEL SOARES ALVES DA SILVA', 'leandrosilva12@ua.pt', 'AC4E9C03-8C71-4B0E-AF0F-B072868BEBA2', '/upload/curriculos/1521.pdf', '', '', '', '1971-01-01'),
...
(1542, 'Luís Pereira', 'LUÍS ANTÓNIO CASTRO MORAIS PINTO PEREIRA', 'luis.pinto.pereira@ua.pt', '7C0AE4E2-DC10-496D-8F26-F674FC154753', '', '', '', '', '1971-01-01'),
...
(1557, 'Luís Valetim', 'LUÍS MIGUEL GOULART VALENTIM', 'lvalentim@ua.pt', '3CDE541D-3BE9-4432-B1C2-D5F9F9B1E744', '', '', '', '', '1971-01-01'),
...
(1602, 'Margarida Martins', 'MARGARIDA SILVA MARTINS', 'margarida.martins@ua.pt', 'A2FF0A2A-52F1-45E6-8869-B9DD2340E385', '/upload/curriculos/1602.pdf', 'https://www.linkedin.com/in/margarida-martins-140086173/', '', '', '1971-01-01'),
(1605, 'Mariana Gameiro', 'MARIANA BALUGA GAMEIRO', 'mari.gameiro@ua.pt', '2E566B1B-75A1-4B72-81C2-4CD0565D14CF', '', '', '', '', '2017-10-23'),
(1608, 'Mariana Ladeiro', 'MARIANA BACÊLO LADEIRO', 'marianaladeiro@ua.pt', '18F478C2-84DB-4150-AFB7-DB40D509CCD6', '', '', '', '', '1971-01-01'),
(1611, 'Mariana Santos', 'MARIANA SOUSA PINHO SANTOS', 'marianasps@ua.pt', '945900A4-7A8E-4998-B935-E85206B02E8D', '', '', '', '', '1971-01-01'),
...
(1620, 'Mário Silva', 'MÁRIO FRANCISCO COSTA SILVA', 'mariosilva@ua.pt', 'A5D099D7-4F7F-4382-874C-59078B7E6DEF', '', '', '', '', '1971-01-01'),
...
(1674, 'André Morais', 'ANDRÉ FILIPE MONIZ MORAIS', 'moraisandre@ua.pt', '777366FB-58C9-4D6C-87B5-6625532C46E5', '', 'https://www.linkedin.com/in/andre-moniz-morais/', '', '', '1971-01-01'),
...
(1698, 'Orlando Macedo', 'ORLANDO JORGE RIBEIRO MACEDO', 'orlando.macedo15@ua.pt', '76D84966-DFCC-4D5E-8319-AC6010DF0700', '', '', '', '', '1971-01-01'),
...
(1713, 'Pedro Amaral', 'PEDRO MIGUEL LOUREIRO AMARAL', 'pedro.amaral@ua.pt', '8E7FAB88-0F36-4824-8103-25257F6FB9D8', '', '', '', '', '1971-01-01'),
(1716, 'Pedro Bastos', 'PEDRO MIGUEL BASTOS DE ALMEIDA', 'pedro.bas@ua.pt', '6671B2E9-0A68-4806-A16F-13CDEA958BFA', '', '', '', '', '1971-01-01'),
...
(1722, 'Pedro Santos', 'PEDRO MIGUEL ALMEIDA SANTOS', 'pedro.miguel50@ua.pt', '025A4C5B-B629-46C1-9184-580C1032909C', '', '', '', '', '1971-01-01'),
...
(1734, 'Pedro Marques', 'PEDRO ALEXANDRE GONÇALVES MARQUES', 'pedroagoncalvesmarques@ua.pt', 'EA5279B0-0B1F-4421-AA04-EDE259F76780', '', '', '', '', '1971-01-01'),
...
(1743, 'Pedro Tavares', 'PEDRO DINIS BASTOS TAVARES', 'pedrod33@ua.pt', '7AFB2BC0-EF13-4D8C-AB91-2EF249CA7CEA', '', '', '', '', '1971-01-01'),
...
(1758, 'Pedro Souto', 'PEDRO MIGUEL GOMES DE ALMEIDA SOUTO', 'pedromgsouto@ua.pt', '44278869-CBA7-4B9B-BD33-849DEC8E6B79', '', '', '', '', '1971-01-01'),
...
(1767, 'Gonçalo Pereira', 'GONÇALO DA COSTA PEREIRA', 'pereira.goncalo@ua.pt', '9B26B8A1-063D-44BF-8590-E75C8FE97D29', '', '', '', '', '1971-01-01'),
...
(1779, 'Pedro Casimiro', 'PEDRO LARANJINHA CASIMIRO', 'plcasimiro@ua.pt', '0F0774DE-E454-41CE-B0C7-6EBF66820B82', '', '', '', '', '1971-01-01'),
(1782, 'Pedro Silva', 'PEDRO MIGUEL ALVES SILVA', 'pmasilva20@ua.pt', 'A4B4B85D-CE88-48EE-B02F-8AE1763F1527', '', '', '', '', '1971-01-01'),
...
(1803, 'Rafael Baptista', 'RAFAEL FERREIRA BAPTISTA', 'rafaelbaptista@ua.pt', 'D2523B84-7133-43F3-8410-6C255DF94D09', '', '', '', '', '1971-01-01'),
...
(1815, 'Renan Ferreira', 'RENAN ALVES FERREIRA', 'renanaferreira@ua.pt', '31FD00B0-3E42-4FA8-AF2D-2E6695E39EF2', '/upload/curriculos/1815.pdf', '', '', '', '1971-01-01'),
(1818, 'Renato Duarte', 'RENATO VALENTE DUARTE', 'renato.duarte@ua.pt', 'A621A8D7-0AB2-4027-B133-8C0BFBD62D74', '', '', '', '', '2013-09-12'),
(1821, 'Rui Fernandes', 'RUI FILIPE MONTEIRO FERNANDES', 'rfmf@ua.pt', '0BBEFA9E-590B-4B1D-AB57-273BC3E3C1DB', '', '', '', '', '1971-01-01'),
...
(1827, 'Ricardo Cruz', 'RICARDO SARAIVA DA CRUZ', 'ricardo.cruz29@ua.pt', '1D65A881-CD4E-4428-BD3C-B7C680CD0B3D', '', '', '', '', '1971-01-01'),
...
(1839, 'Ricardo Gonçalves', 'RICARDO JORGE ALVES GONÇALVES', 'ricardojagoncalves@ua.pt', 'FE33D7CD-ED95-4517-9793-FCBE77898367', '', '', '', '', '1971-01-01'),
...
(1926, 'Susana Gomes', 'SUSANA GONÇALVES GOMES', 'sgg@ua.pt', 'EA4A6E86-1CCB-4CED-BD6A-DA4DC72198AD', '', '', '', '', '1971-01-01'),
...
(1956, 'Tiago Oliveira', 'TIAGO DA SILVA RIBEIRO VAZ OLIVEIRA', 'tiago.srv.oliveira@ua.pt', '431A0A24-BB36-4DFE-9DB8-4ECCB52387C4', '', '', '', '', '1971-01-01'),
...
(1998, 'Tomás Lopes', 'TOMÁS HENRIQUE NOGUEIRA LOPES', 'tomaslopes@ua.pt', 'FD4A5960-AD7F-4503-B19F-72E1DCAF266E', '', '', '', '', '1971-01-01'),
...
(2010, 'Vinicius Ribeiro', 'VINÍCIUS BENITE RIBEIRO', 'viniciusribeiro@ua.pt', '1A3E50D1-E54F-49F3-92BA-40D6F81EBBEC', '', '', '', '', '1971-01-01'),
(2013, 'Vitor Fajardo', 'VÍTOR MANUEL OLIVEIRA FAJARDO', 'vitorfajardo@ua.pt', '9FBF6844-2384-4EC9-B4EC-7BF1D465ED25', '', '', '', '', '2018-01-11'),
(2016, 'Wei Ye', 'WEI YE', 'weiye@ua.pt', 'C3D585A1-2B0F-441A-AE06-4CCC0F744AA4', '', '', '', '', '1971-01-01'),
(2019, 'Yanick Alfredo', 'YANICK HAYES MONDLANE ALFREDO', 'yanick.alfredo@ua.pt', '49ABA8A5-BD5F-491F-9F7C-A800009348BA', '', '', '', '', '2018-12-17'),
(2020, 'Afonso Botô', 'AFONSO MIGUEL SANTOS BÔTO', 'afonso.boto@ua.pt', '', '', '', '', '', '1971-01-01'),
...
(2146, 'Vicente Barros', 'VICENTE MANUEL ANDRADE BARROS', 'vmabarros@ua.pt', '', '', '', '', '', '1971-01-01'),
(2149, 'Tiago Gomes', 'TIAGO CARIDADE GOMES', 'tiagocgomes@ua.pt', '', '', '', '', '', '1971-01-01'),
(2152, 'Rafaela Abrunhosa', 'MARIA RAFAELA ALVES ABRUNHOSA', 'maria.abrunhosa@ua.pt', '', '', '', '', '', '1971-01-01'),
(2155, 'Matilde Teixeira', 'MATILDE MOITAL PORTUGAL SAMPAIO TEIXEIRA', 'matilde.teixeira@ua.pt', '', '', '', '', '', '1971-01-01'),
(2158, 'Hugo Correia', 'HUGO FRANCISCO DA COSTA CORREIA', 'hf.correia@ua.pt', '', '', '', '', '', '1971-01-01'),
(2161, 'Mariana Rosa', 'MARIANA CABRAL DA SILVA SILVEIRA ROSA', '', '', '', '', '', '', '1971-01-01');
...
CREATE TABLE aauav_nei.videos (
  ...
  subtitle character varying(255) DEFAULT NULL,
  image character varying(255) DEFAULT NULL,
  created timestamp DEFAULT CURRENT_TIMESTAMP,
  playlist smallint DEFAULT 0
);
...
INSERT INTO aauav_nei.videos (id, tag, ytId, title, subtitle, image, created, playlist) VALUES
...
INSERT INTO aauav_nei.videos_tags (id, name, color) VALUES
(1, '1A', 'rgb(1, 202, 228)'),
(2, '2A', 'rgb(1, 171, 192)'),
(3, '3A', 'rgb(1, 135, 152)'),
(4, 'MEI', 'rgb(1, 90, 101)'),
...
ALTER TABLE aauav_nei.classificacao_tacaua
  ADD PRIMARY KEY (id);

CREATE INDEX idModalidade ON aauav_nei.classificacao_tacaua(idModalidade);
CREATE INDEX idEquipa ON aauav_nei.classificacao_tacaua(idEquipa);
--
-- Indexes for table companies
--
ALTER TABLE aauav_nei.companies
  ADD PRIMARY KEY (id);

--
-- Indexes for table equipas_tacaua
--
ALTER TABLE aauav_nei.equipas_tacaua
  ADD PRIMARY KEY (id);

--
-- Indexes for table estatistica
--
ALTER TABLE aauav_nei.estatistica
  ADD PRIMARY KEY (id);

--
-- Indexes for table estatistica_comp
--
ALTER TABLE aauav_nei.estatistica_comp
  ADD PRIMARY KEY (id);

--
-- Indexes for table faina
--
ALTER TABLE aauav_nei.faina
  ADD PRIMARY KEY (mandato);

--
-- Indexes for table faina_memb
--
ALTER TABLE aauav_nei.faina_memb
  ADD PRIMARY KEY (id);

CREATE INDEX ano ON aauav_nei.faina_memb(ano);

--
-- Indexes for table faina_member
--
ALTER TABLE aauav_nei.faina_member
  ADD PRIMARY KEY (id, member, year, role);

CREATE INDEX member ON aauav_nei.faina_member(member);
CREATE INDEX year ON aauav_nei.faina_member(year);
CREATE INDEX role ON aauav_nei.faina_member(role);

--
-- Indexes for table faina_roles
--
ALTER TABLE aauav_nei.faina_roles
  ADD PRIMARY KEY (id);

--
-- Indexes for table GenTokens
--
ALTER TABLE aauav_nei.GenTokens
  ADD PRIMARY KEY (id);

--
-- Indexes for table GenTokensComp
--
ALTER TABLE aauav_nei.GenTokensComp
  ADD PRIMARY KEY (id);

--
-- Indexes for table history
--
ALTER TABLE aauav_nei.history
  ADD PRIMARY KEY (moment);

--
-- Indexes for table jogos_tacaua
--
ALTER TABLE aauav_nei.jogos_tacaua
  ADD PRIMARY KEY (id);

--
-- Indexes for table Links
--
ALTER TABLE aauav_nei.Links
  ADD PRIMARY KEY (id);

--
-- Indexes for table merchandisings
--
ALTER TABLE aauav_nei.merchandisings
  ADD PRIMARY KEY (id);

--
-- Indexes for table modalidades_tacaua
--
ALTER TABLE aauav_nei.modalidades_tacaua
  ADD PRIMARY KEY (id);

--
-- Indexes for table NEI_Disciplina
--
ALTER TABLE aauav_nei.NEI_Disciplina
  ADD PRIMARY KEY (paco_code);

--
-- Indexes for table NEI_Disciplina_Apontamentos
--
ALTER TABLE aauav_nei.NEI_Disciplina_Apontamentos
  ADD PRIMARY KEY (disciplina,link_ficheiro);

--
-- Indexes for table NEI_Merch
--
ALTER TABLE aauav_nei.NEI_Merch
  ADD PRIMARY KEY (id);

--
-- Indexes for table news
--
ALTER TABLE aauav_nei.news
  ADD PRIMARY KEY (id);

CREATE INDEX publish_by ON aauav_nei.news(publish_by);
CREATE INDEX changed_by ON aauav_nei.news(changed_by);

--
-- Indexes for table notes
--
ALTER TABLE aauav_nei.notes
  ADD PRIMARY KEY (id);

CREATE INDEX subject ON aauav_nei.notes(subject);
CREATE INDEX author_notes ON aauav_nei.notes(author);
CREATE INDEX schoolYear ON aauav_nei.notes(schoolYear);
CREATE INDEX teacher ON aauav_nei.notes(teacher);
CREATE INDEX type ON aauav_nei.notes(type);

--
-- Indexes for table notes_schoolyear
--
ALTER TABLE aauav_nei.notes_schoolyear
  ADD PRIMARY KEY (id);

--
-- Indexes for table notes_subjects
--
ALTER TABLE aauav_nei.notes_subjects
  ADD PRIMARY KEY (paco_code);

--
-- Indexes for table notes_teachers
--
ALTER TABLE aauav_nei.notes_teachers
  ADD UNIQUE (name),
  ADD PRIMARY KEY (id);

CREATE INDEX name ON aauav_nei.notes_teachers(name);

--
-- Indexes for table notes_thanks
--
ALTER TABLE aauav_nei.notes_thanks
  ADD PRIMARY KEY (id);

CREATE INDEX author_notes_thanks ON aauav_nei.notes_thanks(author);

--
-- Indexes for table notes_types
--
ALTER TABLE aauav_nei.notes_types
  ADD PRIMARY KEY (id);

--
-- Indexes for table partners
--
ALTER TABLE aauav_nei.partners
  ADD PRIMARY KEY (id);

--
-- Indexes for table RecoverToken
--
ALTER TABLE aauav_nei.RecoverToken
  ADD PRIMARY KEY (id);

--
-- Indexes for table redirects
--
ALTER TABLE aauav_nei.redirects
  ADD UNIQUE (alias),
  ADD PRIMARY KEY (id);

CREATE INDEX alias ON aauav_nei.redirects(alias);
--
-- Indexes for table rgm
--
ALTER TABLE aauav_nei.rgm
  ADD PRIMARY KEY (id);

--
-- Indexes for table seniors
--
ALTER TABLE aauav_nei.seniors
  ADD PRIMARY KEY (year,course);

--
-- Indexes for table seniors_students
--
ALTER TABLE aauav_nei.seniors_students
  ADD PRIMARY KEY (year,course, userId);

CREATE INDEX userId ON aauav_nei.seniors_students(userId);

--
-- Indexes for table tacaua_classification
--
ALTER TABLE aauav_nei.tacaua_classification
  ADD PRIMARY KEY (team,modality);

CREATE INDEX modality ON aauav_nei.tacaua_classification(modality);

--
-- Indexes for table tacaua_games
--
ALTER TABLE aauav_nei.tacaua_games
  ADD PRIMARY KEY (id);

CREATE INDEX team1 ON aauav_nei.tacaua_games(team1);
CREATE INDEX team2 ON aauav_nei.tacaua_games(team2);

--
-- Indexes for table tacaua_modalities
--
ALTER TABLE aauav_nei.tacaua_modalities
  ADD PRIMARY KEY (id);

--
-- Indexes for table tacaua_teams
--
ALTER TABLE aauav_nei.tacaua_teams
  ADD PRIMARY KEY (id);

--
-- Indexes for table team
--
ALTER TABLE aauav_nei.team
  ADD PRIMARY KEY (id);

CREATE INDEX user_id ON aauav_nei.team(user_id);

--
-- Indexes for table team_colaborators
--
-- ALTER TABLE aauav_nei.team_colaborators
--   ADD KEY colaborator (colaborator);

CREATE INDEX colaborator ON aauav_nei.team_colaborators(colaborator);
--
-- Indexes for table team_roles
--
ALTER TABLE aauav_nei.team_roles
  ADD PRIMARY KEY (id);

--
-- Indexes for table users
--
ALTER TABLE aauav_nei.users
  ADD PRIMARY KEY (id);

--
-- Indexes for table videos
--
ALTER TABLE aauav_nei.videos
  ADD PRIMARY KEY (id);

CREATE INDEX tag ON aauav_nei.videos(tag);

--
-- Indexes for table videos_tags
--
ALTER TABLE aauav_nei.videos_tags
  ADD PRIMARY KEY (id);
...
--
-- ALTER TABLE aauav_nei.classificacao_tacaua ALTER COLUMN id SET DEFAULT nextval(3);
...
--
ALTER TABLE aauav_nei.classificacao_tacaua
  ADD CONSTRAINT classificacao_tacaua_ibfk_1 FOREIGN KEY (idModalidade) REFERENCES aauav_nei.modalidades_tacaua (id),
  ADD CONSTRAINT classificacao_tacaua_ibfk_2 FOREIGN KEY (idEquipa) REFERENCES aauav_nei.equipas_tacaua (id);

--
-- Constraints for table estatistica
--
ALTER TABLE aauav_nei.estatistica
  ADD CONSTRAINT acesso FOREIGN KEY (id) REFERENCES aauav_nei.users (id);

--
-- Constraints for table faina_memb
--
ALTER TABLE aauav_nei.faina_memb
  ADD CONSTRAINT mandato_k FOREIGN KEY (ano) REFERENCES aauav_nei.faina (mandato);

--
-- Constraints for table faina_member
--
ALTER TABLE aauav_nei.faina_member
  ADD CONSTRAINT faina_member_ibfk_1 FOREIGN KEY (member) REFERENCES aauav_nei.users (id),
  ADD CONSTRAINT faina_member_ibfk_2 FOREIGN KEY (year) REFERENCES aauav_nei.faina (mandato),
  ADD CONSTRAINT faina_member_ibfk_3 FOREIGN KEY (role) REFERENCES aauav_nei.faina_roles (id);

--
-- Constraints for table NEI_Disciplina_Apontamentos
--
ALTER TABLE aauav_nei.NEI_Disciplina_Apontamentos
  ADD CONSTRAINT Disciplina_Apontamentos_FK FOREIGN KEY (disciplina) REFERENCES aauav_nei.NEI_Disciplina (paco_code);

--
-- Constraints for table news
--
ALTER TABLE aauav_nei.news
  ADD CONSTRAINT news_ibfk_2 FOREIGN KEY (publish_by) REFERENCES aauav_nei.users (id),
  ADD CONSTRAINT news_ibfk_3 FOREIGN KEY (changed_by) REFERENCES aauav_nei.users (id);

--
-- Constraints for table notes
--
ALTER TABLE aauav_nei.notes
  ADD CONSTRAINT notes_ibfk_1 FOREIGN KEY (subject) REFERENCES aauav_nei.notes_subjects (paco_code),
  ADD CONSTRAINT notes_ibfk_2 FOREIGN KEY (author) REFERENCES aauav_nei.users (id),
  ADD CONSTRAINT notes_ibfk_3 FOREIGN KEY (schoolYear) REFERENCES aauav_nei.notes_schoolyear (id),
  ADD CONSTRAINT notes_ibfk_4 FOREIGN KEY (teacher) REFERENCES aauav_nei.notes_teachers (id),
  ADD CONSTRAINT notes_ibfk_5 FOREIGN KEY (type) REFERENCES aauav_nei.notes_types (id);

--
-- Constraints for table notes_thanks
--
ALTER TABLE aauav_nei.notes_thanks
  ADD CONSTRAINT notes_thanks_ibfk_1 FOREIGN KEY (author) REFERENCES aauav_nei.users (id);

--
-- Constraints for table seniors_students
--
ALTER TABLE aauav_nei.seniors_students
  ADD CONSTRAINT seniors_students_ibfk_1 FOREIGN KEY (year,course) REFERENCES aauav_nei.seniors (year, course),
  ADD CONSTRAINT seniors_students_ibfk_2 FOREIGN KEY (userId) REFERENCES aauav_nei.users (id);

--
-- Constraints for table tacaua_classification
--
ALTER TABLE aauav_nei.tacaua_classification
  ADD CONSTRAINT tacaua_classification_ibfk_1 FOREIGN KEY (team) REFERENCES aauav_nei.tacaua_teams (id),
  ADD CONSTRAINT tacaua_classification_ibfk_2 FOREIGN KEY (modality) REFERENCES aauav_nei.tacaua_modalities (id);

--
-- Constraints for table tacaua_games
--
ALTER TABLE aauav_nei.tacaua_games
  ADD CONSTRAINT tacaua_games_ibfk_1 FOREIGN KEY (team1) REFERENCES aauav_nei.tacaua_teams (id),
  ADD CONSTRAINT tacaua_games_ibfk_2 FOREIGN KEY (team2) REFERENCES aauav_nei.tacaua_teams (id);

--
-- Constraints for table team
--
ALTER TABLE aauav_nei.team
  ADD CONSTRAINT team_ibfk_1 FOREIGN KEY (user_id) REFERENCES aauav_nei.users (id);

--
-- Constraints for table team_colaborators
--
ALTER TABLE aauav_nei.team_colaborators
  ADD CONSTRAINT team_colaborators_ibfk_1 FOREIGN KEY (colaborator) REFERENCES aauav_nei.users (id);

--
-- Constraints for table videos
--
ALTER TABLE aauav_nei.videos
  ADD CONSTRAINT videos_ibfk_1 FOREIGN KEY (tag) REFERENCES aauav_nei.videos_tags (id);
