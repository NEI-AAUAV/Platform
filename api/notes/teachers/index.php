...
<?php
    ...
    $query_getContent = "SELECT DISTINCT notes_teachers.name, notes_teachers.id FROM notes INNER JOIN notes_teachers ON notes.teacher = notes_teachers.id ORDER BY notes_teachers.name";
