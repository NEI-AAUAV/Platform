...
export default function EditTable({ table, mutate }: EditTableProps) {
  ...
  return (
    <div className="md:grid md:grid-cols-[1fr_min-content] md:gap-8">
      <div className="flex flex-col items-center md:items-start">
        <span className="flex gap-2">
          <textarea
            rows={1}
            className="block max-w-[18rem] select-none resize-none overflow-hidden rounded-3xl py-2 text-3xl font-bold focus:border-transparent focus:outline-none focus:ring-2 focus:ring-light-gold"
            readOnly
            ...
            onFocus={() => {
              ...
              titleRef.current!.style.setProperty("width", "18rem");
            }}
            onBlur={() => {
              titleRef.current!.style.setProperty(
                "width",
        ...
        <h5 className="flex items-center gap-1 sm:mb-10">
