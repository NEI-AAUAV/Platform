...
const InfoTeamSection = () => {
    ...
    return (
        <>
            {data.map((item, index) => (
                <div key={index} className="d-flex flex-wrap" style={{ justifyContent:"space-evenly",fontFamily:"Aldrich",width:"100%",justifyContent:"space-around"}}>
                        ...
                        <div className="rally-tascas-row">
                            <Card variant="bordered" className="rally-card-team-checkpoint">
                                <Card.Body>
                                    ...
                                    <Text style={{color:"white"}}>Score: <span style={{color:"rgb(255, 70, 70)"}}>{item.checkpoint_points} PTS</span></Text>
                        ...
                        <div className="rally-tascas-row">
                            <Card variant="bordered" className="rally-card-team-points">
                                <Card.Body>
                                    ...
                                    <Text style={{color:"rgb(255, 70, 70)"}}>{item.total_score} PTS</Text>
                                </Card.Body>
                            </Card>
                        </div>
                    </div>
