        ...
        {!showCountdown ? (
          <>
            ...
            <div className="d-flex flex-wrap justify-content-around mb-3">
              <TabButton
                active={activeTab === TAB.SCORES}
                onPress={() => setActiveTab(TAB.SCORES)}
                size="sm"
              >
                Scores
              </TabButton>
              ...
              <TabButton
                ...
                onPress={() => setActiveTab(TAB.TEAMS)}
                size="sm"
              >
                Teams
              </TabButton>
            ...
            {activeTab === TAB.MAP && <MapSection />}
            {activeTab === TAB.TEAMS && <TeamsSection />}
            {activeTab === TAB.CARDS && <CardsSection />}
          </>
        ) : (
          <Countdown />
        )}
